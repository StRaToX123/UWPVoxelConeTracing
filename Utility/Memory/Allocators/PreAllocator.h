...
class PreAllocator
{
    public:
        ...
        PreAllocator(const PreAllocator& other) : memory_ptr((T*)other.memory_ptr), memory_size(other.memory_size) {};

        template<typename U>
        PreAllocator(const PreAllocator<U>& other) : memory_ptr((T*)other.memory_ptr), memory_size(other.memory_size) {};
