...
void Sample3DSceneRenderer::CreateDeviceDependentResources()
{
	...
	auto createAssetsTask = createPipelineStateTask.then([this]() {
		...
		DX::ThrowIfFailed(d3dDevice->CreateDescriptorHeap(&imGuiDescriptorHeapDesc, IID_PPV_ARGS(&imGui_cbv_heap)));
		NAME_D3D12_OBJECT(imGui_cbv_heap);
	...
	createAssetsTask.then([this]() 
	{
		...
		////////////////////// ImGui /////////////////////////
		//////////////////////////////////////////////////////
		ImGui_ImplDX12_Init(m_deviceResources->GetD3DDevice(), DX::c_frameCount,
			m_deviceResources->GetBackBufferFormat(), imGui_cbv_heap.Get(),
			imGui_cbv_heap->GetCPUDescriptorHandleForHeapStart(),
			imGui_cbv_heap->GetGPUDescriptorHandleForHeapStart());
