...
namespace ImGui
{
    ...
    IMGUI_API ImGuiContext* CreateContext(Windows::UI::Core::CoreWindow^ coreWindow, ImFontAtlas* shared_font_atlas = NULL);
    ...
    IMGUI_API Windows::UI::Core::CoreWindow^ GetCoreWindow();
