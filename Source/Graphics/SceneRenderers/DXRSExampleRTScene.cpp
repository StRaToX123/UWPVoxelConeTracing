...
#pragma endregion
    ...
    // init camera CB
    DX12Buffer::Description cbDescDXR;
    cbDescDXR.mElementSize = sizeof(CameraBuffer);
    cbDescDXR.mState = D3D12_RESOURCE_STATE_GENERIC_READ;
    cbDescDXR.mDescriptorType = DX12Buffer::DescriptorType::CBV;
    mCameraBuffer = new DX12Buffer(mSandboxFramework->GetD3DDevice(), descriptorManager, mSandboxFramework->GetCommandListGraphics(), cbDescDXR, L"DXR CB");
...
void DXRSExampleRTScene::CreateRaytracingAccelerationStructures()
{
    ...
    //Create BLAS
    {
        //dragon mesh
        {
            ...
            DX12Buffer::Description blasdesc;
            ...
            blasdesc.mDescriptorType = DX12Buffer::DescriptorType::Raw;
            blasdesc.mResourceFlags = D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS;
        
            DX12Buffer* blasScratchBuffer = new DX12Buffer(device, mSandboxFramework->GetDescriptorHeapManager(), commandList, blasdesc, L"BLAS Scratch Buffer");
            ...
            DX12Buffer* blasBuffer = new DX12Buffer(device, mSandboxFramework->GetDescriptorHeapManager(), commandList, blasdesc, L"BLAS Buffer");
    ...
    //Create TLAS
    {
        ...
        desc.mDescriptorType = DX12Buffer::DescriptorType::Raw;
        DX12Buffer* instanceDescriptionBuffer = new DX12Buffer(device, mSandboxFramework->GetDescriptorHeapManager(), commandList, desc, L"Instance Description Buffer");
        ...
        DX12Buffer::Description tlasDesc;
        ...
        tlasDesc.mDescriptorType = DX12Buffer::DescriptorType::Raw;

        DX12Buffer* tlasScratchBuffer = new DX12Buffer(device, mSandboxFramework->GetDescriptorHeapManager(), commandList, tlasDesc, L"TLAS Scratch Buffer");
        ...
        DX12Buffer* tlasBuffer = new DX12Buffer(device, mSandboxFramework->GetDescriptorHeapManager(), commandList, tlasDesc, L"TLAS Buffer");
...
void DXRSExampleRTScene::Render()
{
    ...
    //lighting pass
    {
        ...
        DX12DescriptorHandle cbvHandleLighting = gpuDescriptorHeap->GetHandleBlock(2);
        ...
        DX12DescriptorHandle srvHandleLighting = gpuDescriptorHeap->GetHandleBlock(3);
    ...
    // composite pass
    {
        ...
        DX12DescriptorHandle srvHandleComposite = gpuDescriptorHeap->GetHandleBlock(2);
